...
function schoolpress_footer_nonce_url(){
	echo '<p><a href="' . wp_nonce_url( add_query_arg( array( 'action' => 'get_users' ) ), 'get_users_nonce' ) . '">Get Users</a></p>';
}
...
function schoolpress_footer_nonce_url_action(){
	...
	if ( isset( $_GET['action'] ) && 'get_users' == $_GET['action'] && check_admin_referer( 'get_users_nonce' ) ) {
